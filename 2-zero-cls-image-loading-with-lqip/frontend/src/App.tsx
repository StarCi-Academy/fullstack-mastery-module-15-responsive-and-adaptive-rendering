...
const TITLE = "Zero CLS Image Loading with LQIP"
/** Lesson description shown under the title in both render modes. */
const DESCRIPTION =
    "aspect-ratio box reservation + base64 LQIP blur-up + IntersectionObserver lazy load + fetchpriority/preload hero — zero layout shift, fast LCP, no image library required."
 ...
 * Single-client lesson: both modes render the same LqipImageClient.
 */
